      ...
      <main className="app-main" style={{ padding: 16 }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          >
            ...
            <p style={{ margin: "0 0 14px", fontSize: 13, opacity: 0.8, lineHeight: 1.7 }}>
              Passkey（端末の認証）でログインします。
            </p>

            {msg && (
              <p style={{ margin: "0 0 12px", fontSize: 12, whiteSpace: "pre-wrap", opacity: 0.85 }}>
                {msg}
              </p>
            )}
            ...
            <p style={{ marginTop: 12, fontSize: 11, opacity: 0.7, lineHeight: 1.6 }}>
